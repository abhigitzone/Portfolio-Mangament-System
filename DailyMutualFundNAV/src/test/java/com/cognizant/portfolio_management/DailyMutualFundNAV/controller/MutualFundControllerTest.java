...
//		MvcResult result=mockMvc.perform(get("/dailyallmutualfundnav").header("Authorization", "token")).andExpect(status().isOk())
//		.andReturn();
		//assertEquals(fundList.toString(), result.getResponse().getContentAsString());
	}
